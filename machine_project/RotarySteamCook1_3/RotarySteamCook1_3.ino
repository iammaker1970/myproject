...
void setup() {
  ...
  ArduinoOTA.setHostname("RotaryCook1_sensor_3");
...
//    lastMsg = now;
    ...
    client.publish("RotaryCook1Sensor3/XAcc", String(AcX).c_str(), false);
    client.publish("RotaryCook1Sensor3/YAcc", String(AcY).c_str(), false);
    client.publish("RotaryCook1Sensor3/ZAcc", String(AcZ).c_str(), false);
    //client.publish("/RotaryCook1Sensor3/XGyro", String(GyX).c_str(), true);
    //client.publish("/RotaryCook1Sensor3/YGyro", String(GyY).c_str(), true);
    //client.publish("/RotaryCook1Sensor3/ZGyro", String(GyZ).c_str(), true);
    client.publish("RotaryCook1Sensor3/Temp", String(Temp).c_str(), false);  
