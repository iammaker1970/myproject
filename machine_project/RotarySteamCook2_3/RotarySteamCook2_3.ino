...
//    lastMsg = now;
    ...
    client.publish("RotaryCook2Sensor3/XAcc", String(AcX).c_str(), false);
    client.publish("RotaryCook2Sensor3/YAcc", String(AcY).c_str(), false);
    client.publish("RotaryCook2Sensor3/ZAcc", String(AcZ).c_str(), false);
    ...
    client.publish("RotaryCook2Sensor3/Temp", String(Temp).c_str(), false);  
