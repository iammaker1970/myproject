...
//    lastMsg = now;
    ...
    client.publish("RotaryCook3Sensor1/XAcc", String(AcX).c_str(), true);
    client.publish("RotaryCook3Sensor1/YAcc", String(AcY).c_str(), true);
    client.publish("RotaryCook3Sensor1/ZAcc", String(AcZ).c_str(), true);
    ...
    client.publish("RotaryCook3Sensor1/Temp", String(Temp).c_str(), true);  
