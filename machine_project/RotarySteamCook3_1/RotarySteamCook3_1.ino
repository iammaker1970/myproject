...
void setup() {
  ...
  ArduinoOTA.setHostname("RotaryCook3_sensor_1");
...
//    lastMsg = now;
    ...
    client.publish("RotaryCook3Sensor1/XAcc", String(AcX).c_str(), false);
    client.publish("RotaryCook3Sensor1/YAcc", String(AcY).c_str(), false);
    client.publish("RotaryCook3Sensor1/ZAcc", String(AcZ).c_str(), false);
    //client.publish("/RotaryCook3Sensor1/XGyro", String(GyX).c_str(), true);
    //client.publish("/RotaryCook3Sensor1/YGyro", String(GyY).c_str(), true);
    //client.publish("/RotaryCook3Sensor1/ZGyro", String(GyZ).c_str(), true);
    client.publish("RotaryCook3Sensor1/Temp", String(Temp).c_str(), false);  
