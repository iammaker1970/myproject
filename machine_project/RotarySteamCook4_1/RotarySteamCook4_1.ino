...
void setup() {
  ...
  ArduinoOTA.setHostname("RotaryCook4_sensor_1");
...
//    lastMsg = now;
    ...
    client.publish("RotaryCook4Sensor1/XAcc", String(AcX).c_str(), true);
    client.publish("RotaryCook4Sensor1/YAcc", String(AcY).c_str(), true);
    client.publish("RotaryCook4Sensor1/ZAcc", String(AcZ).c_str(), true);
    //client.publish("/RotaryCook4Sensor1/XGyro", String(GyX).c_str(), true);
    //client.publish("/RotaryCook4Sensor1/YGyro", String(GyY).c_str(), true);
    //client.publish("/RotaryCook4Sensor1/ZGyro", String(GyZ).c_str(), true);
    client.publish("RotaryCook4Sensor1/Temp", String(Temp).c_str(), true);  
