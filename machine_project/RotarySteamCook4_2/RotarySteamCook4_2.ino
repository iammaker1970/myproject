...
//    lastMsg = now;
    ...
    client.publish("RotaryCook4Sensor2/XAcc", String(AcX).c_str(), false);
    client.publish("RotaryCook4Sensor2/YAcc", String(AcY).c_str(), false);
    client.publish("RotaryCook4Sensor2/ZAcc", String(AcZ).c_str(), false);
    ...
    client.publish("RotaryCook4Sensor2/Temp", String(Temp).c_str(), false);  
